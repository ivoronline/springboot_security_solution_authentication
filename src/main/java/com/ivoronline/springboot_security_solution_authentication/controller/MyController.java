package com.ivoronline.springboot_security_solution_authentication.controller;
...
public class MyController {
  ...
  String authenticate(@RequestParam String username, @RequestParam String password) {
    ...
    Authentication outputAuthentication = authenticationManager.authenticate(inputAuthentication);

    //CHECK  AUTHENTICATION OBJECT
    if(!outputAuthentication.isAuthenticated()) {
